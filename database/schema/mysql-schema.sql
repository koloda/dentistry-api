...
CREATE TABLE `patients` (
  ...
  CONSTRAINT `patients_clinic_id_foreign` FOREIGN KEY (`clinic_id`) REFERENCES `clinics` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `tmp_sms_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tmp_sms_code_expired_at` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `users_clinic_id_foreign` FOREIGN KEY (`clinic_id`) REFERENCES `clinics` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2023_11_25_120138_clinics',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2023_11_25_121658_improved_staff_users',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (28,'2023_11_25_152344_create_patients_table',3);
